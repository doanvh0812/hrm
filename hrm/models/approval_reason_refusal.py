...
class ApprovalReasonRefusal(models.Model):
    _name = "approval.reason.refusal"
    _description = "Lý do từ chối"

    reason_refusal = fields.Many2one("approval.reason.refusal", string="Lý do từ chối")
    ...
    def action_approval_reason_refusal(self):
        ...
        return leads.action_refuse(self.reason_refusal.id)
